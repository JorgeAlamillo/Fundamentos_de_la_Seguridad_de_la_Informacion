...
```
ssh -p 64891 picoplayer@saturn.picoctf.net
...
### Notas
- El comando man sirve para consultar la documentacion de los comandos, funciones y programas instalados en el sistema. 