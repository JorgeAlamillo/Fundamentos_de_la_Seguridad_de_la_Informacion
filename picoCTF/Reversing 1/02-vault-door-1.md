...
┌──(JorgeMSI㉿MSI)-[~/picoCTF/reversing/02]
...
--2026-04-29 10:27:38--  https://challenge-files.picoctf.net/c_fickle_tempest/eb2eaca69cb975c96a289b4db182ed439cf7f6bc542b135b8a9a1e9834c068c1/VaultDoor1.java
...
┌──(JorgeMSI㉿MSI)-[~/picoCTF/reversing/02]
└─$ grep "charAt" VaultDoor1.java | sed -E "s/.*charAt\(([0-9]+)\).*'(.)'.*/\1 \2/" | sort -n | awk '{print $2}' | tr -d '\n'
