...
>>> flag = "".join([chr(int(x, 16)) for x in hex_string.split()])
>>> print(flag)
picoCTF{45c11_n0_qu35710n5_1ll_t311_y3_n0_l135_445d4180}
```

### Notas
- ` flag = "".join([chr(int(x, 16)) for x in hex_string.split()]`) Corta el texto en pedazos, convierte cada pedazo de **base 16** a **número**, traduce ese número a su **letra** ASCII, y al final **pégalo todo** sin espacios.